...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "*༆ًغَــــــمِ♧︎︎︎عِـــشؔــق༆*",
  packname: process.env.PACK_NAME || "وفـﹿٰٰٰٖٖٖٜ۬ﹿٰٰٖٖـــا کـﹿٰٰٰٖٖٖٜ۬ﹿٰٰٖٖـی تـﹻ۬ﹻۧ۬ﹻﹿٰٰٰٖﹿﹻۧ۬ﹻ۬ـلاش گـﹻۧ۬ﹻٰ۬ﹻٰ۬ﹻۧ۬ﹻ۬ـینگ ۲۰۱۲",
  botname : process.env.BOT_NAME  || "ZIDDI KING BALOCH",
  ownername:process.env.OWNER_NAME|| "ZIDDI KING",
